...
//            }
    val dialog = builder.create()
        ...
        val daysflag = booleanArrayOf(false,false,false,false,false)
        val daysSelected = ArrayList < String> ()



//        daysSelected.add("Mon")
//        daysSelected.add("Mon2")
//        daysSelected.add("Mon3")
//        daysSelected.add("Mon4")
        var dd : String = ""
        ...
        val classdays = AlertDialog.Builder(context).setTitle("Class Days")
            .setMultiChoiceItems(daysoptions ,booldays ) {_, i, ischecked ->
                ...
                if(ischecked)
                {
                    Toast.makeText(context,"you selected ${daysoptions[i]}",Toast.LENGTH_SHORT).show()
                    Log.d("class",daysoptions[i])
            ...
            .setPositiveButton("Ok"){_,_ ->
                ...
                for (i in booldays.indices) {
                    ...
                    if (checked) {
                        dayClass.text = dayClass.text.toString() + daysoptions[i]
                    }
                }
            }
//
