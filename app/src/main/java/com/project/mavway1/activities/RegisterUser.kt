...
//        else if(checkdomain(email)) {
//            Toast.makeText(this, "Please enter a valid UTA email address", Toast.LENGTH_SHORT).show()
////            TODO: problem in firebase
//            false
//        }
        else {
            true
    ...
    private fun checkdomain(email: String): Boolean {
        return !(email.contains("@uta.edu") or email.contains("@mavs.uta.edu"))
